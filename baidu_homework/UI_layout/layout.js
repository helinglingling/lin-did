...
var RichBase = Base.extend({
    ...
    _delegateEvent:function(){
        ...
        var parentNode = document.querySelector(this.get('parentNodeEvent')) || document.body
    ...
    setChuckdata:function(key,value){
        ...
        //替换内容
        currentNode.parentNode.replaceChild(newHtmlNode,currentNode);
    ...
    EVENTS:{
        ...
        '.agree,.cancel':{
            ...
            touchend:function(self,e){
                document.querySelector("#"+self.get("box_id")).outerHTML = "";
            }
        }
    },
    // 指定当前组件的模板
